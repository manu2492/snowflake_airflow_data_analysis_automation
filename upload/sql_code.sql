-- CATEGORIES
create table "RAPPI"."PUBLIC"."CATEGORIES"(
    category_id text,
    category_name text,
    shortname text,
    sort_name text
...
-- CITIES
create table "RAPPI"."PUBLIC"."CITIES"(
    city text,
    city_id text,
    country text,
    distance float,
...
-- EVENTS
create table "RAPPI"."PUBLIC"."EVENTS"(
    event_id text,
    created timestamp,
    description text, 
    duration float,
...
-- GROUPS
create table "RAPPI"."PUBLIC"."GROUPS"(
    group_id text,
    category_id text,
    category_name text,
...
-- GROUPS_TOPICS
create table "RAPPI"."PUBLIC"."GROUPS_TOPICS"(
    topic_id text,
	topic_key text,
	topic_name text,
	group_id text
...
-- MEMBERS
create table "RAPPI"."PUBLIC"."MEMBERS"(
    member_id text,
	bio text,
	city text,
	country text,
...
-- MEMBERS_TOPICS
create table "RAPPI"."PUBLIC"."MEMBERS_TOPICS"(
    topic_id text,
	topic_key text,
	topic_name text,
	member_id text
...
-- TOPICS
create table "RAPPI"."PUBLIC"."TOPICS"(
    topic_id text,
	description text,
	link text,
	members numeric,
...
-- VENUES
create table "RAPPI"."PUBLIC"."VENUES"(
    venue_id text,
	address_1 text,
	city text,
	country text,
